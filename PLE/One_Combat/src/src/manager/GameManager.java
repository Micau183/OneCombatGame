...
public class GameManager extends MonoBehavior {
	...
	public static String PlayerWinName = "Luffy";
	...
	public static void CheckEndGame() {
		...
		while (iter.hasNext()) {
			...
			if (!playerInformation.isAlive)
				...
				lastPlayer = playerInformation.player;
		}

		if (nombreDead >= nombrePlayer - 1) {
			System.out.println("End game");
			PlayerWinName = ((Character)lastPlayer).characterData.name;
			GameSystem.system.sceneManager.loadScene(2);
		}
	}
