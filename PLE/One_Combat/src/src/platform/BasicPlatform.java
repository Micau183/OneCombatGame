...
public class BasicPlatform extends GameObject{
    ...
    public BasicPlatform() throws IOException {
        ...
        this.components.add(new PlatformActions(this, this.transform));
        this.components.add(new PlatformConditions(this, this.transform));
        
        this.components.add(new Entity(this, this.transform, GameManager.instance.gameSettings.platformAutomate));
