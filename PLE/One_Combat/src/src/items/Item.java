...
import src.items.components.ItemAction;
import src.items.components.ItemBehavior;
import src.items.components.ItemCondition;
import src.items.components.ItemEntity;
...
public class Item extends GameObject {
	...
	public Item(ItemType type, boolean isFixed, FlatVector position) {
		...
		components.add(new ItemEntity(this, transform, GameManager.instance.gameSettings.itemAutomate));
		components.add(new ItemAction(this, transform));
		components.add(new ItemCondition(this, transform));
	}
