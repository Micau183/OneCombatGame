...
public class RoncesCondition extends MonoBehavior implements ICondition {

	private RoncesAttack roncesAttack;
	
	public RoncesCondition(GameObject g, Transform t) {
		super(g, t);
	...
	public boolean Key(int c) {
		switch (c) {
		case 49: // Key(1) canAttack
			return roncesAttack.canAttack();
		default:
