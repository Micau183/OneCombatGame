...
public class CharacterAiHandler extends MonoBehavior {
	...
	public float timePathFinding = 5f;
	public float onTimePathFinding = 0f;
	...
	public boolean isClose() {
		return FlatMath.distance(transform.position, getClosestCharacterPos()) < 3;
	}
